...
public class Registration 
{
	...
	public Registration() {
		...
		l1=new JLabel("Name : ");
		l1.setBounds(10, 70, 90, 20);
		l1.setFont(new Font("Serif",Font.BOLD,14));
		
		t1=new JTextField();
		t1.setBounds(140, 72,150, 20);
		...
		t4.setBounds(140, 132,150, 20);

		l4=new JLabel("confirm Password : ");
		l4.setBounds(10, 160,132, 20);
		l4.setFont(new Font("Serif",Font.BOLD,14));

		t2=new JPasswordField();
		t2.setBounds(140, 162,150, 20);
